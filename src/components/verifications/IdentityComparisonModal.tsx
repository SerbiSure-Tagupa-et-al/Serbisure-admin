...
const InteractiveImageFrame: React.FC<InteractiveImageFrameProps> = ({
  ...
  return (
    <div
      ...
      className={`mt-3 bg-zinc-950 rounded-2xl border border-zinc-800/60 overflow-hidden relative flex items-center justify-center h-[360px] sm:h-[420px] select-none ${
...
export const IdentityComparisonModal: React.FC<IdentityComparisonModalProps> = ({
  ...
  return (
    ...
    >
      <div 
        className="relative bg-[#0D0D11] text-white rounded-3xl border border-zinc-800 shadow-2xl max-w-5xl w-full max-h-[92vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-150"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        {/* Modal Body: Comparison Viewport */}
